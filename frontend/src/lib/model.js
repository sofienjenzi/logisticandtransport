...
/** spec = [id, i18nLabelKey, field, datasets]. The label is a filters.* translation key resolved by FilterBar. */
export const filterSpecs = {
  executif: [
    ['country', 'filters.country', 'country', ['sales', 'livraisons', 'transport', 'stocks', 'satisfaction']],
    ['year', 'filters.year', 'year', ['sales', 'livraisons', 'transport', 'stocks', 'satisfaction']],
    ['marginBand', 'filters.marginBand', 'marginBand', ['sales']],
    ['nps', 'filters.npsClass', 'nps', ['satisfaction']],
  ],
  ventes: [
    ['country', 'filters.country', 'country', ['sales']],
    ['year', 'filters.year', 'year', ['sales']],
    ['client', 'filters.client', 'client', ['sales']],
    ['product', 'filters.product', 'product', ['sales']],
    ['channel', 'filters.channel', 'channel', ['sales']],
    ['marginBand', 'filters.marginBand', 'marginBand', ['sales']],
  ],
  achats: [
    ['country', 'filters.country', 'country', ['achats']],
    ['year', 'filters.year', 'year', ['achats']],
    ['supplier', 'filters.supplier', 'supplier', ['achats']],
    ['product', 'filters.product', 'product', ['achats']],
    ['delayClass', 'filters.delayClass', 'delayClass', ['achats']],
  ],
  stocks: [
    ['country', 'filters.country', 'country', ['stocks']],
    ['year', 'filters.year', 'year', ['stocks']],
    ['warehouse', 'filters.warehouse', 'warehouse', ['stocks']],
    ['product', 'filters.product', 'product', ['stocks']],
    ['status', 'filters.stockStatus', 'status', ['stocks']],
  ],
  livraisons: [
    ['country', 'filters.country', 'country', ['livraisons']],
    ['year', 'filters.year', 'year', ['livraisons']],
    ['client', 'filters.client', 'client', ['livraisons']],
    ['driver', 'filters.driver', 'driver', ['livraisons']],
    ['vehicle', 'filters.vehicle', 'vehicle', ['livraisons']],
    ['delayCategory', 'filters.delayCategory', 'delayCategory', ['livraisons']],
  ],
  transport: [
    ['country', 'filters.country', 'country', ['transport']],
    ['year', 'filters.year', 'year', ['transport']],
    ['route', 'filters.route', 'route', ['transport']],
    ['carrier', 'filters.carrier', 'carrier', ['transport']],
    ['mode', 'filters.mode', 'mode', ['transport']],
    ['fillBand', 'filters.fillBand', 'fillBand', ['transport']],
  ],
  vehicules: [
    ['country', 'filters.country', 'country', ['vehicules', 'fuel']],
    ['year', 'filters.year', 'year', ['vehicules', 'fuel']],
    ['vehicle', 'filters.vehicle', 'vehicle', ['vehicules', 'fuel']],
    ['vehicleType', 'filters.vehicleType', 'vehicleType', ['vehicules', 'fuel']],
    ['vehicleStatus', 'filters.vehicleStatus', 'vehicleStatus', ['vehicules', 'fuel']],
  ],
  rh: [
    ['country', 'filters.country', 'country', ['presence']],
    ['year', 'filters.year', 'year', ['presence']],
    ['driver', 'filters.driver', 'driver', ['presence']],
    ['status', 'filters.presenceStatus', 'status', ['presence']],
    ['experienceBand', 'filters.experienceBand', 'experienceBand', ['presence']],
  ],
  incidents: [
    ['country', 'filters.country', 'country', ['incidents']],
    ['year', 'filters.year', 'year', ['incidents']],
    ['severity', 'filters.severity', 'severity', ['incidents']],
    ['incidentType', 'filters.incidentType', 'incidentType', ['incidents']],
    ['route', 'filters.route', 'route', ['incidents']],
    ['vehicle', 'filters.vehicle', 'vehicle', ['incidents']],
  ],
  satisfaction: [
    ['country', 'filters.country', 'country', ['satisfaction']],
    ['year', 'filters.year', 'year', ['satisfaction']],
    ['client', 'filters.client', 'client', ['satisfaction']],
    ['nps', 'filters.npsClass', 'nps', ['satisfaction']],
    ['band', 'filters.satisfactionBand', 'band', ['satisfaction']],
  ],
};
